...
CREATE TABLE `VatsimData` (
    ...
    `subDivisionId` VARCHAR(191) NULL,
    `ratingLong` VARCHAR(191) NOT NULL,
    `ratingShort` VARCHAR(191) NOT NULL,
    `ratingId` INTEGER NOT NULL,
    `pilotRatingLong` VARCHAR(191) NOT NULL,
    `pilotRatingShort` VARCHAR(191) NOT NULL,
    `pilotRatingId` INTEGER NOT NULL,
    `lastUpdate` DATETIME(3) NULL,

    UNIQUE INDEX `VatsimData_cid_key`(`cid`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
